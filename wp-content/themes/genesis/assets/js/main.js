;(function () {
    ...
    if(document.getElementById('form__down')){
        const formDown = document.getElementById('form__down');
        ...
        async function formSend(e) {
          ...
          formValidate(formDown);
          
          let formData = new FormData(formDown);
        ...
        function formValidate(form) {
          ...
          for (let i = 0; i < formReq.length; i++) {
            ...
            if(input.classList.contains('main-form__user-email')) {
                if(validEmail(input)) {
                  formAddError(input);
                  error++;
                }
        ...
        const checkBox = document.querySelector('.main-form__checkbox');
        const checkBoxLabel = document.querySelector('.form__policy-text');
...
;(function () {
    ...
    let options = [
        ...
        {
            modal_brief_btn: 'btn-consult',
            modal_call_title: 'Запись на консультацию',
            modal_call_subtitle: 'Оставьте свои контактные данные и мы свяжемся с вами в ближайшее время',
            modal_form_id: 'form-consult',
            phone_input_id: 'modal__input-phone'
        },
        {
                    ...
                    <div class="modal">
                        <div class="modal__close"></div>
                            ...
                            <div class="input__wraps">
                                <input class="form__input-phone _req" type="text" name="user-name" placeholder="Ваше имя">
                                <input class="form__input-phone _req" type="text" id="${ phoneInputID }" name="user-phone" placeholder="Ваш телефон">
                            </div>
    ...
    window.addEventListener('click', (e) => {
        ...
        if(e.target.closest('.btn-send')) {
            ...
            setTimeout(() => {
                modalThanks(options[2].modal_call_title, options[2].modal_call_subtitle);
            }, 1000);
        }
    });
