...
(function () {// const formDown = document.querySelector('.main-form--down');
  // formDown.addEventListener('submit', (e) => {
  //     e.preventDefault();
  //     const formData = new FormData(formDown);
  //     fetch('./form.php', {
  //         method: 'post',
  //         body: formData
  //     }).then( response => {
...
(function () {
  if (document.querySelector('.licenses--page')) {
    var imgHide = function imgHide() {
      out = '';
      body.removeChild(div);
      body.classList.remove('no-scroll');
      html.classList.remove('html-overflow');
      var scrollY = body.style.top; // Восстанавливаем расположение ползунка прокрутки
    ...
    var minimizedImg = document.querySelectorAll('.minimized');
    var body = document.getElementsByTagName('body')[0];
    var html = body.parentNode;
    var out = '';
    var div = document.createElement('div');
    div.classList.add('overlay');
    minimizedImg.forEach(function (el) {
      el.addEventListener('click', function () {
        ...
        var scrollY = document.documentElement.style.getPropertyValue('--scroll-y'); // Определяем текущее расстояние от верха страницы
    ...
    window.addEventListener('scroll', function () {
      // Отслеживаем текущее расстояние от верха страницы
...
"use strict"; // ФИКСИРУЕМ HEADER ПРИ СКРОЛЕ
...
(function () {
  if (document.querySelector('.swiper-lisences--small-first')) {
    var swiperLisencesSmallFirst = new Swiper('.swiper-lisences--small-first', {
      slidesPerView: 1,
      loopedSlides: 1,
      grabCursor: true,
      loop: true,
  ...
  if (document.querySelector('.swiper-lisences--small-second')) {
    var swiperLisencesSmallSecond = new Swiper('.swiper-lisences--small-second', {
      slidesPerView: 1,
      loopedSlides: 1,
      grabCursor: true,
      loop: true,
...
(function () {
  if (document.querySelector('.swiper-first')) {
    ...
    var swiperFirst = document.querySelector('.swiper-first');
    var mySwiper;
    mobileSlider();
    window.addEventListener('resize', function () {
      mobileSlider();
  ...
  if (document.querySelector('.swiper-second')) {
    var _mobileSlider = function _mobileSlider() {
      if (window.innerWidth < 1320 && swiperSecond.dataset.mobile == 'false') {
        _mySwiper = new Swiper(swiperSecond, {
          spaceBetween: 30,
          slidesPerView: 3,
          loopedSlides: 1,
          autoHeight: true,
    ...
    var swiperSecond = document.querySelector('.swiper-second');
  ...
  if (document.querySelector('.swiper-third')) {
    var _mobileSlider2 = function _mobileSlider2() {
      if (window.innerWidth < 1320 && swiperThird.dataset.mobile == 'false') {
        _mySwiper2 = new Swiper(swiperThird, {
          spaceBetween: 30,
          slidesPerView: 3,
          loopedSlides: 1,
          autoHeight: true,
    ...
    var swiperThird = document.querySelector('.swiper-third');
  ...
  if (document.querySelector('.swiper-fourth')) {
    var _mobileSlider3 = function _mobileSlider3() {
      if (window.innerWidth < 1320 && swiperFourth.dataset.mobile == 'false') {
        _mySwiper3 = new Swiper(swiperFourth, {
          spaceBetween: 30,
          slidesPerView: 3,
          loopedSlides: 1,
          autoHeight: true,
    ...
    var swiperFourth = document.querySelector('.swiper-fourth');
  ...
  if (document.querySelector('.swiper-fifth')) {
    var _mobileSlider4 = function _mobileSlider4() {
      if (window.innerWidth < 1320 && swiperFifth.dataset.mobile == 'false') {
        _mySwiper4 = new Swiper(swiperFifth, {
          spaceBetween: 30,
          slidesPerView: 3,
          loopedSlides: 1,
          autoHeight: true,
    ...
    var swiperFifth = document.querySelector('.swiper-fifth');
